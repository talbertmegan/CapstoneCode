...
namespace __pythran__spectral
{
  ...
  typename _lombscargle::type<argument_type0, argument_type1, argument_type2>::result_type _lombscargle::operator()(argument_type0&& x, argument_type1&& y, argument_type2&& freqs) const
  {
    ...
    {
      long  __target5050081488 = std::get<0>(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, freqs));
      for (long  i=0L; i < __target5050081488; i += 1L)
      {
        ...
        {
          long  __target5050009488 = std::get<0>(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, x));
          for (long  j=0L; j < __target5050009488; j += 1L)
          {
